...
void BlinkTransient::initialize()
{
    ...
    if (contrasts.fixedIntensities[0] < 0) {
        ...
        if(ACCESS((folder + "pest1").c_str()) == -1) MKDIR((folder + "pest1").c_str());
        if (ACCESS((folder + "pest1/pest.txt").c_str()) == -1)
            contrasts.pests[1] = Pest(getConfiguration()->getInitAmp1() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp1(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep1(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[1] = Pest((folder + "pest2").c_str());

        if(ACCESS((folder + "pest2").c_str()) == -1) MKDIR((folder + "pest2").c_str());
        if (ACCESS((folder + "pest2/pest.txt").c_str()) == -1)
            contrasts.pests[2] = Pest(getConfiguration()->getInitAmp2() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp2(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep2(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[2] = Pest((folder + "pest2").c_str());

        if(ACCESS((folder + "pest3").c_str()) == -1) MKDIR((folder + "pest3").c_str());
        if (ACCESS((folder + "pest3/pest.txt").c_str()) == -1)
            contrasts.pests[3] = Pest(getConfiguration()->getInitAmp3() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp3(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep3(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[3] = Pest((folder + "pest3").c_str());

        if(ACCESS((folder + "pest4").c_str()) == -1) MKDIR((folder + "pest4").c_str());
        if (ACCESS((folder + "pest4/pest.txt").c_str()) == -1)
            contrasts.pests[4] = Pest(getConfiguration()->getInitAmp4() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp4(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep4(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[4] = Pest((folder + "pest4").c_str());

        if(ACCESS((folder + "pest5").c_str()) == -1) MKDIR((folder + "pest5").c_str());
        if (ACCESS((folder + "pest5/pest.txt").c_str()) == -1)
            contrasts.pests[5] = Pest(getConfiguration()->getInitAmp4() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp5(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep5(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[5] = Pest((folder + "pest5").c_str());

        if(ACCESS((folder + "pest6").c_str()) == -1) MKDIR((folder + "pest6").c_str());
        if (ACCESS((folder + "pest6/pest.txt").c_str()) == -1)
            contrasts.pests[6] = Pest(getConfiguration()->getInitAmp4() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp6(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep6(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[6] = Pest((folder + "pest6").c_str());

        if(ACCESS((folder + "pest7").c_str()) == -1) MKDIR((folder + "pest7").c_str());
        if (ACCESS((folder + "pest7/pest.txt").c_str()) == -1)
            contrasts.pests[7] = Pest(getConfiguration()->getInitAmp4() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp7(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep7(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[7] = Pest((folder + "pest7").c_str());

        if(ACCESS((folder + "pest8").c_str()) == -1) MKDIR((folder + "pest8").c_str());
        if (ACCESS((folder + "pest8/pest.txt").c_str()) == -1)
            contrasts.pests[8] = Pest(getConfiguration()->getInitAmp4() > bgnLuminance ? bgnLuminance : getConfiguration()->getInitAmp8(), getConfiguration()->getTargetRatio(),
                getConfiguration()->getInitStep8(), getConfiguration()->getWaldConst(), getConfiguration()->isLog(), getConfiguration()->isFixedStep());
        else contrasts.pests[8] = Pest((folder + "pest8").c_str());
...
void BlinkTransient::teardown()
{
    ...
    if(contrasts.fixedIntensities[0] < 0){
        string folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest1";
        contrasts.pests[1].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest2";
        contrasts.pests[2].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest3";
        contrasts.pests[3].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest4";
        contrasts.pests[4].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest5";
        contrasts.pests[5].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest6";
        contrasts.pests[6].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest7";
        contrasts.pests[7].saveInstance(folder.c_str());
        folder = "../../dev_ws/user_tasks/blink_transient/data/" + getConfiguration()->getSubject() + "/pest8";
        contrasts.pests[8].saveInstance(folder.c_str());
    }
}
