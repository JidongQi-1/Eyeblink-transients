...
struct BlinkTransientConfiguration : public eye::protocol::EyerisTaskConfiguration
{
        ...
        EyerisTaskConfiguration(other)
    {
        ...
        // PEST
        initializeInitAmpLow(0.6);             // initial amplitude of the gabor ( 0 ~ bgnLuminance ); minus means no PEST adopted
        initializeInitAmpHigh(0.6);             // initial amplitude of the gabor ( 0 ~ bgnLuminance ); minus means no PEST adopted
        ...
        initializeSpFreq6(6);
        initializeSpFreq7(7);
        initializeSpFreq8(8);         // threshold for convergence   // 0.75
    ...
    // PEST
    LC_PROPERTY_FLOAT(PEST_INI_TAMP_LOW, "Pest_Init_Amp_Low", InitAmpLow)                  // initial amplitude of the gabor ( 0 ~ bgnLuminance ); minus means no PEST adopted
    LC_PROPERTY_FLOAT(PEST_INI_TAMP_HIGH, "Pest_Init_Amp_High", InitAmpHigh)                  // initial amplitude of the gabor ( 0 ~ bgnLuminance ); minus means no PEST adopted
